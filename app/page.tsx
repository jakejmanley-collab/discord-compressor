  ...
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col items-center justify-center py-10 font-sans">
      <div className="w-full flex flex-col items-center max-w-5xl px-4">
        ...
        <section className="grid md:grid-cols-3 gap-6 w-full max-w-4xl mt-16">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            <Files className="w-8 h-8 text-indigo-600 mb-4" />
        ...
        <section className="mt-20 w-full max-w-4xl">
          <h2 className="text-2xl font-bold text-center text-slate-900 mb-8">Format-Specific Tools</h2>
      ...
      <footer className="mt-16 py-8 text-center text-slate-400 text-sm border-t border-slate-200 w-full px-4">
        ...
        <p>&copy; {new Date().getFullYear()} Discord Compression Tool. Optimized for speed and privacy.</p>
      </footer>
    </main>
  );
}
